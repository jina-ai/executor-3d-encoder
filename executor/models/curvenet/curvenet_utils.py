"""Adapted from: https://github.com/tiangexiang/CurveNet/blob/main/core/models/curvenet_util.py
"""
...
class LPFA(nn.Module):
    def __init__(
        self, in_channel, out_channel, k, mlp_num=2, initial=False, shape='bnc'
    ):
