"""
ref: https://github.com/hancyran/RepSurf/blob/44b8da1a40/modules/recons_utils.py
"""
...
from ..pointconv import index_points, knn_point
...
def knn_recons(k, center, context, cuda=False):
    idx = knn_point(k, context, center)
    torch.cuda.empty_cache()

    group_xyz = index_points(context, idx)  # [B, N, K, C]
    torch.cuda.empty_cache()
    return group_xyz
